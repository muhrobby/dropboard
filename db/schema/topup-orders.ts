...
export const topupOrders = pgTable(
    "topup_order",
    {
        ...
        // Our generated invoice number (TOPUP20260210...) - used for webhook lookup
        externalId: text("external_id"),
        // Gateway's invoice ID (Xendit/DOKU internal ID)
    ...
    (table) => [
        ...
        index("idx_topup_order_external_id").on(table.externalId),
